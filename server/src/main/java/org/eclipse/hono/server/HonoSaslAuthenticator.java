...
public final class HonoSaslAuthenticator implements ProtonSaslAuthenticator {
    ...
    public void init(final NetSocket socket, final ProtonConnection protonConnection, final Transport transport) {
        ...
        LOG.debug("setting list of supported SASL mechanisms");
    ...
    public boolean process() {
        ...
        if (remoteMechanisms.length > 0) {
            ...
            LOG.debug("client wants to use {} SASL mechanism [hostname: {}, state: {}]",
...
//        vertx.eventBus().send("hono.authentication", null, reply -> {
//            if (reply.succeeded()) {
//                
//            } else {
//                
